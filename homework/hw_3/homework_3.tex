...
Note that you should do many trials per choice of $N_S$ to get typical
behavior!
...
\begin{enumerate}
  \item Establish a performance baseline by timing the single-core
    ...
    cities (from just a few cities up to 100 cities).  Also use timers to identify the costly part(s) of your
    code, as an opportunity for future optimization. How does the cost
    change?  (Hint: do multiple trials and change the random seed in
    the random number generator to get a sense of performance variability.)
