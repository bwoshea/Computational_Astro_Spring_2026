...
of the typical
behavior!  \textcolor{red}{Regarding trials, it's very important to recall that Python's random library
uses the Mersenne Twister algorithm, which is a pseudorandom number generator -- it uses an algorithm that
generates a sequence of numbers that are \textit{statistically random},
but which are repeatable given the same initial number.  This means
