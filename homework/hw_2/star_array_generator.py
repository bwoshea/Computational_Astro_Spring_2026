"""
Code for part 2 of homework 2 - the function's doc string
describes the behavior.
include this with ``from star_array_generator import make_star_array''
"""
...
def make_star_array(Ngrid=103,Nstars=1,Lbox=1.0,Mstar = 1.0):
    ...
    # if Nstars != 1 generate a bunch of stars!
