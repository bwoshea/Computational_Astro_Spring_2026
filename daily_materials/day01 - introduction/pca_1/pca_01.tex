...
\noindent
\textbf{This assignment is due by 11:59 p.m. on Monday, January 12, 2026.}
...
\item Chapter 1 and Section 2.7 of \textit{Computational Physics},
  by M. Newman
\item ``Best Practices for Scientific Computing'' by G. Wilson et
  al. (\href{https://arxiv.org/abs/1210.0530}{arXiv:1210.0530}; PDF provided)
\item ``Computing in Astronomy'' slides by B.W. O'Shea (from a
  presentation given to
  first-year astrophysics PhD students in October 2025; PDF provided)
...
\item Read, but do not summarize, the O'Shea slides.  This covers some
  general points about computing in astronomy and astrophysics and has
  some potentially useful information for you, but doesn't merit a
  summary!
