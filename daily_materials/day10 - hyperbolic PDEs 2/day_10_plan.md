...
* Discuss plans for the rest of the semester - where are we at?
  * Show schedule + talk about plans.  When do we move to HPCC intro?
...
* Discussion questions:
  * Why is the finite volume approximation useful for solving the wave advection problem?  (Allows us to use fluxes (divergence theorem) and greatly expands our options in terms of the ways we solve these problems.)
...
2026 - we did NOT get to the in-class assignment at all.