...
\noindent
\textbf{This assignment is due the evening of Monday January 26, 2026.}
...
\item Documentation for \href{https://docs.python.org/3/library/pdb.html}{pdb -- the
    Python debugger}.  Another useful resource is this $\simeq 30$
  minute youtube video on 
  \href{https://www.youtube.com/watch?v=6KQ_h0XBmxk}{using the pdb debugger}
...
\item
  ...
  a really awesome and useful integrated development environment, or
  IDE).  You may also find this
  \href{https://www.youtube.com/watch?v=b4p-SBjHh28}{video on
    debugging in VSCode} useful as well.
